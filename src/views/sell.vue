            ...
            <b-form>
              <div class="row">
                <b-form-input
                  ...
                  required
                ></b-form-input>
                <div class="col-12 col-md-2 pt-1 text-right d-none">Refill</div>
                ...
                <div class="col-12 col-md-2 pt-1 text-right d-none">Remove</div>
                ...
                <div class="col-12 col-md-2 pt-1 text-right d-none">Diff</div>
                <div class="col-12 col-md-2 d-none">
                  <b-form-input
